...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int TITLE_BG_COLOR = Color.parseColor("#F5F6FA");
    ...
    public TitleItemDecoration(Context context, List<SortModel> data) {
        ...
        radius = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, context.getResources().getDisplayMetrics());
